...
namespace pureba2register.Controllers
{
    public class ReferenciasPersonalesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReferenciasPersonalesID,NombresReferencia,PrimerApellidoReferencia,SegundoApellidoReferencia,CargoReferencia,TelefonoFijoReferencia,ExtTelefonoReferencia,TelefonoMovilReferencia,InformacionPersonalID,ParentescoReferenciaID,TipoReferenciaID")] ReferenciasPersonales referenciasPersonales)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReferenciasPersonalesID,NombresReferencia,PrimerApellidoReferencia,SegundoApellidoReferencia,CargoReferencia,TelefonoFijoReferencia,ExtTelefonoReferencia,TelefonoMovilReferencia,InformacionPersonalID,ParentescoReferenciaID,TipoReferenciaID")] ReferenciasPersonales referenciasPersonales)
        {
            if (ModelState.IsValid)
            {
